...
class BookingHistoryModel extends StatelessWidget {
  @override
...
class UserBookingHistoryModel extends StatefulWidget {
  @override
  _UserBookingHistoryModelState createState() {
    return _UserBookingHistoryModelState();
  }
}
...
class _UserBookingHistoryModelState extends State<UserBookingHistoryModel> {
  ...
  Stream<QuerySnapshot> getData() async*{
    ...
    yield* Firestore.instance.collection('booking_tbl')
